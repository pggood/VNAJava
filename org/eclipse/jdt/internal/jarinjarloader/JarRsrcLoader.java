...
public static void main(String[] args) throws ClassNotFoundException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException, IOException {
    ...
    // Explicitly cast args to Object array
   ...
   private static ClassLoader getParentClassLoader() throws InvocationTargetException, IllegalAccessException {
      try {
         ...
         if (var10000 == null) {
            try {
               var10000 = Class.forName("java.lang.ClassLoader");
         ...
         Method platformClassLoader = var10000.getMethod("getPlatformClassLoader", (Class[])null);
         return (ClassLoader)platformClassLoader.invoke((Object)null, (Object[])null);
   ...
   private static class ManifestInfo {
      ...
      // $FF: synthetic method
      ManifestInfo(JarRsrcLoader.ManifestInfo var1) {
         this();
      }
   }
}
