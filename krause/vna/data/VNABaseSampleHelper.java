...
public class VNABaseSampleHelper {
   ...
   public static VNABaseSample createDeltaSample(VNABaseSample sample1, VNABaseSample sample2, int numberIntermediateSamples) {
      VNABaseSample rc = new VNABaseSample();
      rc.setHasPData(sample1.hasPData());
      rc.setFrequency((sample2.getFrequency() - sample1.getFrequency()) / (long)numberIntermediateSamples);
      rc.setAngle((sample2.getAngle() - sample1.getAngle()) / (double)numberIntermediateSamples);
      rc.setLoss((sample2.getLoss() - sample1.getLoss()) / (double)numberIntermediateSamples);
   ...
   public static VNABaseSample createNewSampleWithDelta(VNABaseSample sampleBase, VNABaseSample sampleDelta) {
      VNABaseSample rc = new VNABaseSample();
