package krause.vna.device.serial.vnarduino.gui;
...
import krause.vna.device.serial.vnarduino.VNADriverSerialVNArduinoDIB;
import krause.vna.device.serial.vnarduino.VNADriverSerialVNArduinoMessages;
...
public class VNADriverSerialVNArduinoDialog extends VNADriverDialog {
   ...
   private VNADriverSerialVNArduinoDIB dib;
   ...
   public VNADriverSerialVNArduinoDialog(VNAMainFrame pMainFrame, IVNADriver pDriver) {
      super(pMainFrame.getJFrame(), pMainFrame);
      TraceHelper.entry(this, "VNADriverSerialStdDialog");
      this.driver = pDriver;
      this.dib = (VNADriverSerialVNArduinoDIB)this.driver.getDeviceInfoBlock();
      this.setTitle(VNADriverSerialVNArduinoMessages.getString("Dialog.title"));
      this.setDefaultCloseOperation(0);
      this.setProperties(this.config);
      this.setConfigurationPrefix("VNADriverSerialVNArduinoDialog");
      ...
      this.lblMax = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblPhaseMax.text"));
      this.panel.add(this.lblMax, "");
      JLabel lblMin = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblLossMax.text"));
      this.panel.add(lblMin, "wrap");
      JLabel lblLoss = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblLossMin.text"));
      ...
      this.lblPhaseMin = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblPhaseMin.text"));
      ...
      JLabel lblFreqMin = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblFreqMin.text"));
      ...
      this.lblNoOfSteps = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblNoOfSteps.text"));
      ...
      JLabel lblDDSTicks = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblDDSTicks.text"));
      ...
      this.lblOpenTimeout = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblOpenTimeout.text"));
      ...
      this.lblReadTimeout = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblReadTimeout.text"));
      ...
      this.lblCommandDelay = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblCommandDelay.text"));
      ...
      this.lblBaudrate = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblBaudrate.text"));
      ...
      this.lblReference = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblReference.text"));
      ...
      JButton btnReset = new JButton(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.btnReset.text"));
      pnlButtons.add(btnReset);
      btnReset.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            VNADriverSerialVNArduinoDialog.this.doReset();
         }
      });
      btnReset.setToolTipText(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.btnReset.toolTipText"));
      this.btOK = new JButton(VNADriverSerialVNArduinoMessages.getString("Button.OK"));
      this.btOK.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent arg0) {
            VNADriverSerialVNArduinoDialog.this.doOK();
         }
      });
      JButton btCancel = new JButton(VNADriverSerialVNArduinoMessages.getString("Button.Cancel"));
      btCancel.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            VNADriverSerialVNArduinoDialog.this.doDialogCancel();
         }
      });
   ...
   protected void doOK() {
      ...
      int frq = IntegerValidator.parse(this.txtTicks.getText(), 999999, 999999999, VNADriverSerialVNArduinoMessages.getString("Dialog.lblDDSTicks.text"), results);
      int openTimeout = IntegerValidator.parse(this.txtOpenTimeout.getText(), 500, 99000, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblOpenTimeout.text"), results);
      int readTimeout = IntegerValidator.parse(this.txtReadTimeout.getText(), 500, 99000, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblReadTimeout.text"), results);
      int commandDelay = IntegerValidator.parse(this.txtCommandDelay.getText(), 50, 99000, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblCommandDelay.text"), results);
      int baudrate = IntegerValidator.parse(this.txtBaudrate.getText(), 1200, 115200, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblBaudrate.text"), results);
      int steps = IntegerValidator.parse(this.txtSteps.getText(), 2000, 25000, VNADriverSerialVNArduinoMessages.getString("Dialog.lblNoOfSteps.text"), results);
      if (results.isEmpty()) {
   ...
   private void updateFieldsFromDIB(VNADriverSerialVNArduinoDIB pDIB) {
