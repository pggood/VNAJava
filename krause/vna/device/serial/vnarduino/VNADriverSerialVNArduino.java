...
public class VNADriverSerialVNArduino extends VNADriverSerialBase {
   ...
   public VNADriverSerialVNArduino() {
      String methodName = "VNADriverSerialVNArduino";
      TraceHelper.entry(this, "VNADriverSerialVNArduino");
      this.setMathHelper(new VNADriverSerialStd2MathHelper(this));
      this.setDeviceInfoBlock(new VNADriverSerialVNArduinoDIB());
      this.getDeviceInfoBlock().restore(this.config, this.getDriverConfigPrefix());
      TraceHelper.exit(this, "VNADriverSerialVNArduino");
   }
   ...
   public void init() throws InitializationException {
      ...
      super.init();
      VNADriverSerialVNArduinoDIB dib = (VNADriverSerialVNArduinoDIB)this.getDeviceInfoBlock();
      ...
      } catch (PortInUseException | UnsupportedCommOperationException | ProcessingException var5) {
   ...
   private VNABaseSample[] receiveRawMessage(long frequency, int pNumSamples, long frequencyStep, IVNABackgroundTaskStatusListener listener) throws ProcessingException {
      ...
      TraceHelper.entry(this, "receiveRawMessage", "fStart=%d #=%d freqStep=%d", frequency, pNumSamples, frequencyStep);
   ...
   public void startGenerator(long frequencyI, long frequencyQ, int attenuationI, int attenuationQ, int phase, int mainAttenuation) throws ProcessingException {
      ...
      TraceHelper.entry(this, "startGenerator", "frq=%d", frequencyI);
      if (this.getPort() != null) {
         this.flushInputStream();
         this.sendAsAsciiString("0");
