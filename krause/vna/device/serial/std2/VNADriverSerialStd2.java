...
import krause.vna.device.serial.std2.gui.VNADriverSerialStd2Dialog;
...
public class VNADriverSerialStd2 extends VNADriverSerialBase {
   static final int NUM_BYTES_PER_SAMPLE = 4;

   public VNADriverSerialStd2() {
      String methodName = "VNADriverSerialStd2";
      TraceHelper.entry(this, "VNADriverSerialStd2");
      this.setMathHelper(new VNADriverSerialStd2MathHelper(this));
      this.setDeviceInfoBlock(new VNADriverSerialStd2DIB());
      this.getDeviceInfoBlock().restore(this.config, this.getDriverConfigPrefix());
      TraceHelper.exit(this, "VNADriverSerialStd2");
   }
   ...
   public void init() throws InitializationException {
      ...
      super.init();
      VNADriverSerialStd2DIB dib = (VNADriverSerialStd2DIB)this.getDeviceInfoBlock();
   ...
   public void showDriverDialog(VNAMainFrame pMF) {
      String methodName = "showDriverDialog";
      TraceHelper.entry(this, "showDriverDialog");
      VNADriverSerialStd2Dialog dlg = new VNADriverSerialStd2Dialog(pMF, this);
      dlg.dispose();
