package krause.vna.device.serial.pro2.generator;
...
public class VNAGeneratorPro2Dialog extends KrauseDialog implements ChangeListener, ActionListener, ClipboardOwner, AdjustmentListener, ILocationAwareDialog {
   ...
   private String groupSeparator = "" + DecimalFormatSymbols.getInstance().getGroupingSeparator();
   ...
   public VNAGeneratorPro2Dialog(VNAMainFrame pMainFrame, IVNADriver pDriver) {
      super((Window)pMainFrame.getJFrame(), true);
      this.driver = pDriver;
      this.dib = (VNADriverSerialPro2DIB)this.driver.getDeviceInfoBlock();
      this.setTitle(VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.title"));
      ...
      this.btOK = new JButton(VNADriverSerialPro2Messages.getString("Button.Close"));
   ...
   private JPanel createNUMPanel() {
      ...
      panelNUM.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.control"), 4, 2, (Font)null, new Color(0, 0, 0)));
      ...
      panelNUM.add(panel1);
      JLabel lblValue = new JLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblValue.text"));
      panel1.add(lblValue);
      this.txtVALUE = new JTextField();
      this.txtVALUE.addKeyListener(new KeyAdapter() {
         public void keyReleased(KeyEvent e) {
            if (e.getKeyCode() >= 115 && e.getKeyCode() <= 120) {
               VNAGeneratorPro2Dialog.this.doProcessFKey(e);
            }

         }
      });
      panel1.add(this.txtVALUE);
      this.txtVALUE.setColumns(10);
      JPanel panel3 = new JPanel();
      panelNUM.add(panel3);
      JLabel lblEndWithFor = new JLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblEndWithFor.text"));
      panel3.add(lblEndWithFor);
      JPanel panel2 = new JPanel();
      panelNUM.add(panel2);
      JLabel lblTuneTheFrequency = new JLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblTuneTheFrequency.text"));
      panel2.add(lblTuneTheFrequency);
      this.lblOnAir = new JLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblOnAir.text"));
      panel2.add(this.lblOnAir);
      ...
      this.lblOnAir.addMouseListener(new MouseAdapter() {
         public void mouseClicked(MouseEvent e) {
            VNAGeneratorPro2Dialog.this.doClickOnAirField(e);
         }
      });
   ...
   private JPanel createHELPPanel() {
      ...
      panelHLP.setBorder(new TitledBorder((Border)null, VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.help"), 4, 2, (Font)null, (Color)null));
      ...
      txtrFEnterI.setText(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.txtrFEnterI.text"));
   ...
   private JPanel createPHASEPanel() {
      ...
      panelPhase.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.phaseDiff"), 4, 2, (Font)null, new Color(0, 0, 0)));
      ...
      panelPhase.add(this.createNewLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.label_7.text")), "wrap");
   ...
   private JPanel createFREQPanel() {
      ...
      panelFRQ.setBorder(new TitledBorder((Border)null, VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.Frequency"), 4, 2, (Font)null, (Color)null));
      JPanel panelFRQI = new JPanel(new MigLayout("", "0", "0"));
      panelFRQ.add(panelFRQI, "");
      panelFRQI.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.frq.i"), 4, 2, (Font)null, new Color(0, 0, 0)));
      ...
      JButton btFrqRight2Left = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button.text"));
      btFrqRight2Left.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            VNAGeneratorPro2Dialog.this.handlerFrequencyI.setValue(VNAGeneratorPro2Dialog.this.handlerFrequencyQ.getValue());
            VNAGeneratorPro2Dialog.this.startGenerator();
         }
      });
      panelIQLink.add(btFrqRight2Left, "wrap");
      this.btLinkFrq = new JToggleButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.toggleButton.text"));
      this.btLinkFrq.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
         }
      });
      panelIQLink.add(this.btLinkFrq, "wrap");
      JButton btFrqLeft2Right = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button_1.text"));
      btFrqLeft2Right.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            VNAGeneratorPro2Dialog.this.handlerFrequencyQ.setValue(VNAGeneratorPro2Dialog.this.handlerFrequencyI.getValue());
            VNAGeneratorPro2Dialog.this.startGenerator();
         }
      });
      ...
      this.panelFRQQ.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.frq.q"), 4, 2, (Font)null, new Color(0, 0, 0)));
   ...
   private JPanel createATTPanel() {
      ...
      panelATT.setBorder(new TitledBorder((Border)null, VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.att"), 4, 2, (Font)null, (Color)null));
      JPanel panelATTI = new JPanel(new MigLayout("", "", ""));
      panelATTI.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.att.i"), 4, 2, (Font)null, new Color(0, 0, 0)));
      ...
      panelATTI.add(this.createNewLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblDb.text")), "");
      JPanel panelATTCenter = new JPanel(new MigLayout("", "", ""));
      panelATT.add(panelATTCenter, "");
      JButton btAttRight2Left = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button_2.text"));
      btAttRight2Left.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            VNAGeneratorPro2Dialog.this.handlerAttenuationI.setValue(VNAGeneratorPro2Dialog.this.handlerAttenuationQ.getValue());
            VNAGeneratorPro2Dialog.this.startGenerator();
         }
      });
      ...
      JButton btAttLeft2Right = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button_3.text"));
      btAttLeft2Right.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            VNAGeneratorPro2Dialog.this.handlerAttenuationQ.setValue(VNAGeneratorPro2Dialog.this.handlerAttenuationI.getValue());
            VNAGeneratorPro2Dialog.this.startGenerator();
         }
      });
      panelATTCenter.add(btAttLeft2Right, "");
      JPanel panelATTQ = new JPanel(new MigLayout("", "", ""));
      panelATTQ.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.att.q"), 4, 2, (Font)null, new Color(0, 0, 0)));
      ...
      panelATTQ.add(this.createNewLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblDb.text")), "");
      return panelATT;
   }
